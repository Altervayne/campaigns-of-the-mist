      ...
      >
         ...
         >
            ...
            <button
               ...
               title={t('Tabs.newTab')}
               className="shrink-0 mb-2 ml-1 mr-1.5 flex items-center justify-center rounded-md px-2 py-2 touch-target text-muted-foreground hover:bg-muted hover:text-foreground cursor-pointer"
            >
