         ...
         >
            ...
            {breadcrumbPath.length > 0 && (
               <div className="mt-2 flex items-center gap-2">
                  <div onClick={() => navigateToFolder(null)} className="shrink-0 cursor-pointer rounded p-1 hover:bg-muted touch-target" role="button" aria-label={t('Drawer.backToRoot')}>
