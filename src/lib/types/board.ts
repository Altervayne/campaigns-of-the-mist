...
// The surface-agnostic drawing types now live in the neutral drawing engine (board, PDF, and future
// surfaces share them); re-exported here so existing `@/lib/types/board` importers keep working.
export type { Stroke, BrushKind, ActiveTool } from '@/lib/drawing/types';
