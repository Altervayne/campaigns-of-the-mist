...
// -- Local Imports --
import { BRUSH_MIN_WIDTH_FACTOR, DEFAULT_STROKE_WIDTH, HIGHLIGHTER_OPACITY, MIN_LINE_LENGTH, NIB_ANGLE, SHAPE_ELLIPSE_SEGMENTS } from './constants';
import { ellipseVertices, isLineDegenerate, pointsBounds, rebasePoints, regularPolygonVertices, shapeBoxCorners, snapAngle, strokeHitsPoint, strokeIntersectsRect } from './strokeGeometry';
...
import { brushOpacity, isAppendTool, strokeColorToCss, strokePaint } from './strokePaint';
import { makePenStroke, makeStroke } from './strokeFactory';
